...
public class GuideScreen extends Screen {
    ...
    private static final int GUIDE_VERSION = 4; // 4: запирание дверей в своём городе (2026-07-21)
    ...
    private static final Page[] PAGES = {
            ...
            new Page("Города", new String[]{
                    ...
                    "## Запертые двери",
                    "Sneak+ПКМ по двери в своём городе — повесить замок:",
                    "сначала для всех, ещё раз — кроме своих, ещё — снять",
                    "Запертую дверь чужой не откроет и не сломает",
                    "## Витрина",
            ...
            new Page("Профессии", new String[]{
                    "## Клавиша N",
                    "7 профессий: шахтёр, фермер, охотник, рыбак,",
                    "строитель, исследователь и лесоруб",
                    "XP капает за обычные дела — копай, выращивай,",
                    "сражайся, лови рыбу, строй, исследуй, руби лес",
                    "## Таланты и активки",
                    "Каждый уровень даёт очко таланта — вкладывай,",
                    "новые ряды открываются с уровнем профессии",
                    "> G — применить активку, зажать G — выбрать",
            ...
            new Page("Мир и удобства", new String[]{
                    ...
                    "> /mapimg <ссылка> — картинка на карте (доступно всем)",
                    "",
