...
public class GuideScreen extends Screen {
    ...
    private static final Page[] PAGES = {
            new Page("Первые шаги", new String[]{
                    ...
                    "## Меню Domino Craft",
                    "Клавиша K — города, контракты, розыск, рынок и топы",
                    "## Мелочи",
                    "Ники игроков скрыты — кликни по игроку ПКМ,",
                    "и на пару секунд увидишь его ник и город",
            ...
            new Page("Города", new String[]{
                    ...
                    "Вкладка «Мой город» в K-меню: основать, пригласить,",
                    "в открытый город можно вступить без приглашения",
                    "## Жизнь города",
                    "Кровать и точка возрождения работают ТОЛЬКО",
                    "в границах своего города",
                    "Баффы и общие сундуки — вкладка «Хозяйство»",
                    "Дорога от города до спавна — кнопка там же, оплата землёй",
            }),
